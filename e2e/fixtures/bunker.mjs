...
// Deterministic test keypair — hex-encoded private key (NOT nsec format).
// NDKPrivateKeySigner accepts hex strings directly.
const E2E_BUNKER_PRIVATE_KEY = 'a1233c40904e48ddaad99366f9cc6d64fccdda09dca44204210a5b7c2e82b2cb';

// Relay the bunker connects to (same relay the app uses during E2E tests)
const RELAY_URL = 'ws://localhost:7777';

const signer = new NDKPrivateKeySigner(E2E_BUNKER_PRIVATE_KEY);
...
console.log(`[bunker] Ready. URL: ${E2E_BUNKER_URL}`);
